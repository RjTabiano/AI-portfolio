export default function Contact() {
    return (
      <div className="bg-[#333333] rounded-2xl p-4 sm:p-6 md:p-8 w-full max-w-4xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-1 mb-6">
          <h2 className="text-xl sm:text-2xl font-bold text-white">Contacts</h2>
        ...
        <div className="flex flex-wrap gap-2 sm:gap-4 text-sm text-white/50">
