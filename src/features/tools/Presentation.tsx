            ...
            <div className="grid grid-cols-1 items-center gap-6 sm:gap-10 md:grid-cols-2">
                ...
                <div className="flex flex-col h-full space-y">
                    ...
                    <p className="text-white mt-6 leading-relaxed whitespace-pre-line">Hi! I’m Rj 👋<br />
                        I’m an IT graduate and Software Support Engineer at ToFu AI, specializing in backend development, AI integrations, and full-stack engineering. I’m passionate about building innovative solutions and constantly exploring what’s next in tech.</p>
